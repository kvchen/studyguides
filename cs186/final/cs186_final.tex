...
\texti{{Entitlogical schema, not physical schema.y set}: a co

Used to model llection of similar entities. All entities in the set have the same attributes, each entity set has a key (underlined), each attribute has a domain \\
